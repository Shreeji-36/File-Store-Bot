...
PHOTO_ABOUT = "AgACAgUAAxkBAAMOaYW6rjxIK_h7A-EzfmyL_wt1HOwAAt0NaxtqEylUwNO42hL1-ZUACAEAAwIAA3gABx4E"
RESTART_PHOTO_ID = "AgACAgUAAxkBAAMKaYW6PejBmLfNCqR4virDeN_iQg0AAtwNaxtqEylUX-DqsHHTn1AACAEAAwIAA3gABx4E"
FORCE_SUB_PHOTO = "AgACAgUAAxkBAAMSaYW6-e5fULFOeuNs4GZwmnCMu9YAAuYNaxtqEylUQhBn9JeiFwkACAEAAwIAA3kABx4E"
    ...
    if key and key.startswith("FLINK_"):
        ...
        if d and (sent_ids or sticker_mid):
            ...
            alert = await context.bot.send_message(
                chat_id,
                f"<b>⚠️ Dᴜᴇ ᴛᴏ Cᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs....</b>\n<blockquote>Yᴏᴜʀ ғɪʟᴇs ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴡɪᴛʜɪɴ {d // 60} Mɪɴᴜᴛᴇs. Sᴏ ᴘʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ᴛʜᴇᴍ ᴛᴏ ᴀɴʏ ᴏᴛʜᴇʀ ᴘʟᴀᴄᴇ ғᴏʀ ғᴜᴛᴜʀᴇ ᴀᴠᴀɪʟᴀʙɪʟɪᴛʏ.</blockquote>",
                parse_mode=constants.ParseMode.HTML
            )
...
async def link_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not has_permission(uid):
        await update.message.reply_text(
            "<blockquote>ғᴜᴄᴋ ʏᴏᴜ, ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴍʏ ᴍᴀsᴛᴇʀ. ɢᴏ ᴀᴡᴀʏ, ʙɪᴛᴄʜ 🙃..</blockquote>",
            parse_mode=constants.ParseMode.HTML
        )
        return
