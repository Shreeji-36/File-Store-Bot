...
HELP_PHOTO_ID = "https://i.ibb.co/CK6WjrFJ/x.jpg"
...
f"<b>◈ Hᴇʏ  {update.effective_user.mention_html()} ×</b>\n"        
"<blockquote expandable><b>➪ I ᴀᴍ ᴀ ᴘʀɪᴠᴀᴛᴇ ғɪʟᴇ sʜᴀʀɪɴɢ ʙᴏᴛ, ᴍᴇᴀɴᴛ ᴛᴏ ᴘʀᴏᴠɪᴅᴇ ғɪʟᴇs ᴀɴᴅ ɴᴇᴄᴇssᴀʀʏ sᴛᴜғғ ᴛʜʀᴏᴜɢʜ sᴘᴇᴄɪᴀʟ ʟɪɴᴋ ғᴏʀ sᴘᴇᴄɪғɪᴄ ᴄʜᴀɴɴᴇʟs.\n"
"➖➖➖➖➖➖➖➖➖\n"
